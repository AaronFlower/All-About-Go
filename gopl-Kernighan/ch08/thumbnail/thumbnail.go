...
func Image(src image.Image) image.Image {
	// Compute thumnail size, preserving aspect ratio
...
// ImageFile reads an image from infile and writes a thumbnail-size version of it
// in the same directory. It returns the generated file name, e.g. "foo.thumb.jpeg"
